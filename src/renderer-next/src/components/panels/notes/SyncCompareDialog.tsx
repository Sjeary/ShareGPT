    ...
    >
      ...
      >
        ...
        <div className="max-h-[60vh] space-y-3 overflow-auto p-4">
          ...
          <Section icon={ArrowDownToLine} title="从云端更新" paths={report.fromCloud} tone="text-blue-500" />
          <Section icon={GitMerge} title="自动合并" paths={report.autoMerged} tone="text-emerald-500" />
          <Section
            icon={AlertTriangle}
            ...
            tone="text-amber-500"
          />
          <Section icon={Trash2} title="已删除" paths={report.deleted} tone="text-rose-500" />
        </div>
      </div>
    </div>
  )
