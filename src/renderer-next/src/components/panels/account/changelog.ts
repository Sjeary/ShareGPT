...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-08-28',
    highlights: [
      '保留既有多 AI Environment、环境配置和网页登录资料；管理员默认拥有高级环境与全部启用线路，关闭功能、撤权或覆盖升级都不会删除本地数据。',
      ...
      '记住密码后，重启或覆盖升级会自动恢复登录；管理员默认拥有高级 AI 与全部启用线路，关闭功能或撤权不会删除环境、网页登录态和本地网页数据；服务器升级继续兼容已发布的 1.0.x 客户端。',
      'AI 页面切换会复用原网页视图和已验证线路；更新显示、下载和安装只认 GitHub Latest Release tag，错误元数据会在下载或安装前被拒绝；Translation 与 Notes AI 支持公网 HTTP/HTTPS，并保留明文风险提示、SSRF 与危险地址防护。',
    ],
  },
  {
    version: '1.0.8',
